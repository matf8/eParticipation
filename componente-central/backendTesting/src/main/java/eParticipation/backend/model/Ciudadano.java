...
public class Ciudadano extends UsuarioFrontOffice {
	...
	public Ciudadano(Long id, String cedula, String nombre, String correo, Date fNac, String nacionalidad, String domicilio,
	...
	public DtCiudadano getDt() {
		...
		return new DtCiudadano(getIdUsuarioFO().toString(), getCedula(), getNombreCompleto(), getCorreo(), dt.toString(), getNacionalidad(),
	...
	public String toString() {
		return "Ciudadano(cedula=" + this.getCedula() + ", nombre=" + this.getNombreCompleto() + ", correo=" + this.getCorreo() +
				...
				", mensajes=" + this.getMensajes() + ", certificados=" + this.certificados + ", notificaciones=" + this.notificaciones+ ")";
