...
public class ProcesoParticipativo {
	...
	public ProcesoParticipativo(Long id, String nombre, Date fecha, String descripcionAlcance, List<String> instrumentos, String fase, String creador) {
		super();
		this.idProceso = id;
		this.nombre = nombre;
		this.fecha = fecha;
