  ...
  return (
    <>
      ...
      <p>
        ...
        eParticipation usa y protege la información que es proporcionada por sus
      ...
      <p>
        eParticipation está altamente comprometido para cumplir con el
      ...
      <p>
        ...
        <a href="https://noticias-realmadrid.es/">noticias</a>. Usted puede
        aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores
        aceptan cookies automáticamente pues sirve para tener un mejor servicio
        web. También usted puede cambiar la configuración de su ordenador para
      ...
      <p>
        ...
        <a href="https://plantillaterminosycondicionestiendaonline.com/">
      ...
      <p>
        eParticipation Se reserva el derecho de cambiar los términos de la
        presente Política de Privacidad en cualquier momento.
      </p>
      <p>
        Esta politica de privacidad se han generado en{" "}
        <a href="https://politicadeprivacidadplantilla.com/">
