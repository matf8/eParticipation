...
public class DtCiudadano {
	...
	private List<String> proSeguidos;
	...
	public DtCiudadano(String cedula, String nombreCompleto, String correo, String fNac, String nacionalidad, String domicilio, String role) {
		this.cedula = cedula;
		this.nombreCompleto = nombreCompleto;
		this.correo = correo;
		this.fNac = fNac;
