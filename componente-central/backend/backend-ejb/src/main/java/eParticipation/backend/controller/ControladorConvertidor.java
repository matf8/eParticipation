...
public class ControladorConvertidor implements ConverterService {	
		
	public JSONObject jsonCiudadano(DtCiudadano ciudadano) {
		JSONObject jsonCiudadano = new JSONObject();
		jsonCiudadano.put("cedula", ciudadano.getCedula());
		...
		jsonCiudadano.put("mensajes", ciudadano.getMensajes());	
		jsonCiudadano.put("procesosParticipando", ciudadano.getProPart());	
		jsonCiudadano.put("procesosSeguidos", ciudadano.getProSeguidos());	
	...
	public JSONObject jsonProceso(DtProceso i) {
		...
		jsonProceso.put("participantes", i.getParticipantes());
		jsonProceso.put("creador", i.getCreador());
		return jsonProceso;	
	}
